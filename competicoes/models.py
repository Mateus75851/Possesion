...
class Partida(models.Model):
    ...
    status = models.CharField(
        max_length=20, choices=StatusPartida.choices, default=StatusPartida.PENDENTE
    )
...
class Atleta(models.Model):
    ...
    posicao_principal = models.CharField(
        max_length=20, choices=PosicaoPrincipalAtleta.choices
    )
